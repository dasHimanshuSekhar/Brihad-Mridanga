...
export let orders: Order[] = [
    { id: 'ord1', name: 'Alice', address: '123 Main St', mobile: '1112223333', email: 'alice@example.com', items: [{ bookId: '1', quantity: 2 }, { bookId: '2', quantity: 3 }], totalAmount: 70.95, timestamp: new Date('2024-01-10') },
    { id: 'ord2', name: 'Bob', address: '456 Oak Ave', mobile: '4445556666', email: 'bob@example.com', referralCode: '1112223333', items: [{ bookId: '3', quantity: 5 }], totalAmount: 54.95, timestamp: new Date('2024-01-12') },
    { id: 'ord3', name: 'Charlie', address: '789 Pine Ln', mobile: '7778889999', email: 'charlie@example.com', items: [{ bookId: '1', quantity: 18 }], totalAmount: 233.82, timestamp: new Date('2024-01-15') },
    { id: 'ord4', name: 'Diana', address: '101 Maple Rd', mobile: '1011021033', email: 'diana@example.com', referralCode: '7778889999', items: [{ bookId: '5', quantity: 25 }], totalAmount: 449.75, timestamp: new Date('2024-02-01') },
    { id: 'ord5', name: 'Eve', address: '212 Birch Ct', mobile: '2122132144', email: 'eve@example.com', referralCode: '7778889999', items: [{ bookId: '6', quantity: 30 }], totalAmount: 449.70, timestamp: new Date('2024-02-05') },
    { id: 'ord6', name: 'Frank', address: '333 Elm St', mobile: '3334445555', email: 'frank@example.com', referralCode: '7778889999', items: [{ bookId: '7', quantity: 50 }], totalAmount: 449.50, timestamp: new Date('2024-02-10') },
];
